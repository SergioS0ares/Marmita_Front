...
// Descrição do conjunto de testes para o componente AddNewProductComponent
describe('AddNewProductComponent', () => {
  let component: AddNewProductComponent; // Declaração da variável para a instância do componente
  let fixture: ComponentFixture<AddNewProductComponent>; // Declaração da variável para o fixture do componente

  // Bloco de configuração antes de cada teste
  beforeEach(async () => {
    // Configuração do módulo de teste com o componente a ser testado
    await TestBed.configureTestingModule({
      declarations: [ AddNewProductComponent ] // Declara o componente que será testado
    })
